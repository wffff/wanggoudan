 ...
 */
public class OAuthTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices, ConsumerTokenServices, InitializingBean {
    ...
    private OAuth2RefreshToken createRefreshToken(OAuth2Authentication authentication) {
        ...
        String value = Utils.extractTokenKey(UUID.randomUUID().toString());
    ...
    private OAuth2AccessToken createAccessToken(OAuth2Authentication authentication, OAuth2RefreshToken refreshToken) {
        ...
        DefaultOAuth2AccessToken token = new DefaultOAuth2AccessToken(Utils.extractTokenKey(UUID.randomUUID().toString()));
