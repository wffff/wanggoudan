package cn.goudan.wang.passport.baseconfig.utils;
...
public class RegexUtils {
    ...
    public enum Type {
        ...
        IS_NUMBER_POSITIVE("^[+]{0,1}(\\d+)$|^[+]{0,1}(\\d+\\.\\d+)$"),//正数
        IS_NUMBER_NEGATIVE("^[-]{0,1}(\\d+)$|^[-]{0,1}(\\d+\\.\\d+)$"),//负数
        ...
        IS_USERNAME("^[A-Za-z0-9_\\-]+$"),//用户名
        IS_COMPANY_NAME("^[A-Za-z0-9_()（）\\-\\u4e00-\\u9fa5]+$"),//单位名
        ;
...
//        System.out.println(date);
        System.out.println(RegexUtils.check(Type.IS_NUMBER_POSITIVE, "0.9"));
        System.out.println(RegexUtils.check(Type.IS_NUMBER_POSITIVE, "01"));
        System.out.println(RegexUtils.check(Type.IS_NUMBER_POSITIVE, "1.9"));
        System.out.println(RegexUtils.check(Type.IS_NUMBER_NEGATIVE, "-1.9"));
        System.out.println(RegexUtils.check(Type.IS_NUMBER_POSITIVE, "9.0"));
//        System.out.println(RegexUtils.check(Type.NOT_NULL, " "));
//        System.out.println(RegexUtils.check(Type.NOT_NULL, null));
//        System.out.println(RegexUtils.check(Type.NOT_NULL, ""));
//        System.out.println(RegexUtils.check(Type.NOT_NULL, "aa "));
//
//        System.out.println(RegexUtils.check(Type.NOT_NULL, "aa "));
